...
class Setting < RailsSettings::Base
  cache_prefix { "v1" }
  SETTING_FIELDS = %w{ main_title about_company_title about_company_description about_company_content
    ...
    footer_title footer_description subscribers_title subscribers_description address email phone request_title
